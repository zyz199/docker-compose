...
# 源镜像仓库
source_image_registry_prefix="registry.cn-hangzhou.aliyuncs.com/zhangyuezong/"
# 目标镜像仓库
target_image_registry_prefix="registry.cn-hangzhou.aliyuncs.com/zhangyuezong/test-"
